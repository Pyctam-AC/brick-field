  ...
  return (
    <header className="header">
      ...
      <div className="header__item">
        ...
        <h1 className="header__title">Балтымский<br /> Кирпичный&nbsp;ЗАВОД</h1>
        <h3 className="header__address">
          <b>Екатеринбург,</b> <br /> пос.&nbsp;Садовый,<br /> ул.&nbsp;Валимхаматова, д.&nbsp;36{" "}
        </h3>
        </div>
        <div className="header__item">
        <p className="header__schedule">Для заказов:<br /> пн-пт<br /> с&nbsp;8:00 до&nbsp;17:00</p>
